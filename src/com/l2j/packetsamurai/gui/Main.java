...
import com.l2j.packetsamurai.utils.Say2;
...
public class Main implements IUserInterface {
	...
	public void init() {
		...
		//TODO:Messeage
		JMenuItem itemPlugins = new JMenuItem("Say2");
		itemPlugins.setActionCommand("ExportSay2");
		itemPlugins.addActionListener(_menuListener);
		_pluginMenu.add(itemPlugins);
	...
	private void exportSay2()
	{
		if (getViewerTab().getComponentCount() > 0) {
			...
			if (pane != null) {
				...
				new Say2(packets, sessionName).parse();
			}
		}
	}
	...
	public class MenuActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent ev) {
			...
			else if(actionCmd.equals("ExportSay2"))
			{
				exportSay2();
			}
